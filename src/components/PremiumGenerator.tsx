...
const models: (TextToImageModel & { description: string })[] = [
  ...
  { id: 'gpt-image-1', name: 'OpenAI GPT Image Model', supportsNegativePrompt: false, description: "The best image generation model from OpenAI. It makes the best images, use the prompt improver!"},
